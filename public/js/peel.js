...
smartredfox.link_url = escape('http://www.smartredfox.com');

//Should the link open in a new window
smartredfox.newWindow = false;

//What images do you want to show
smartredfox.small_image = 'small.png'; //must be 75px x 75px
smartredfox.big_image = 'large.png'; //must be 500px x 500px
